...
$scope.A1=0,$scope.A2=0,$scope.A3=0,$scope.A4=0,$scope.A5=0,$scope.A6=0,$scope.A7=0;
$scope.B1=0,$scope.B2=0,$scope.B3=0;
$scope.G1=0,$scope.G2=0,$scope.G3=0,$scope.G4=0;
$scope.D1=0,$scope.D2=0;
$scope.E1=0,$scope.E2=0,$scope.E3=0,$scope.E4=0;

$scope.changeA1 = function(selectA1){$scope.A1=helpers.changeValueRange(selectA1);}//range
...
$scope.changeE3 = function(selectE3){$scope.E3=helpers.changeValueRange(selectE3);}//range
$scope.changeE4 = function(selectE4){$scope.E4=helpers.changeValue(selectE4);}

$scope.resultA=function(){return (parseInt($scope.A2,10)*20/100+parseInt($scope.A2,10)*25/100+parseInt($scope.A3,10)*25/100+parseInt($scope.A4,10)*5/100+parseInt($scope.A5,10)*10/100+parseInt($scope.A6,10)*10/100+parseInt($scope.A7,10)*5/100)*10;}
...
$scope.resultE=function(){return (parseInt($scope.E1,10)*15/100+parseInt($scope.E2,10)*25/100+parseInt($scope.E3,10)*10/100+parseInt($scope.E4,10)*50/100)*10;}
$scope.resultFinal=function(){return parseInt($scope.resultA(),10)*25/100+parseInt($scope.resultB(),10)*15/100+parseInt($scope.resultG(),10)*25/100+parseInt($scope.resultD(),10)*10/100+parseInt($scope.resultE(),10)*25/100||0;}
